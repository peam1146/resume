...
export const technologies = [
  {
    section: "Languages:",
    details:
      "JavaScript (proficient), Node.js (proficient), TypeScript (proficient), Golang (proficient), Dart (proficient), SQL, Python, C, C++, Rust, JAVA.",
  },
  {
    section: "Frameworks:",
    details:
...
export const workExperiences = [
  ...
  {
    position: "Project Manager and DevOps Engineer",
    company: "Thinc.",
...
export const projects = [
  ...
  {
    name: "Sheriff board game",
    details: "My first game project from PROGRAMMING METHODOLOGY subject.",
    url: "github.com/peam1146/sherrif-board-game",
  },
  {
    name: "SCCU voting",
    details:
